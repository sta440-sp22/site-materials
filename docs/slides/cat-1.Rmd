...
```{r, eval=TRUE, echo=FALSE, warning = F, message = F, out.width = "40%"}
library(knitr)
include_graphics("img/ipd.jpg")
```
...
```{r, echo = F}
ipd <- read.csv("data/ipd.csv")
ipd2x2 <- ipd[ipd$Serotype %in% c("Serotype 10", "Serotype 31"),]
```
